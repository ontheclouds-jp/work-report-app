...
const GUIDE_STEPS: GuideStep[] = [
  ...
  },
  {
    ...
    body: "先に「PDF出力設定」で宛先・会社名・氏名を登録してください（宛先は会社名のみ入力し、「御中」は自動で付きます。宛先ごとに税区分「外税」「内税」も選べます）。その後、「締め期間集計」画面または「データ管理」画面で月度（例：8/21〜9/20の期間は「9月度」）を選び、「PDF出力」ボタンを押すと、A4サイズの業務日報PDFが保存されます。",
  },
  {
